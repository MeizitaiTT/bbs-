		...
		<div class="row">
			<div class="col-xs-3">
				<ul class="nav nav-pills nav-stacked">
					...
					<li role="presentation"><a href="<%=path%>/manage/userManage.jsp">用户管理</a>
					</li>
			...
			<div class="col-md-9">
				...
				<form id="form1" action="<%=path %>/update_subject.action?Id=<%=subject.getId() %>" method="post" enctype="multipart/form-data">


                        <div class="form-group">
                            <img alt="" class="avatar left" height="70" src=".<%=subject.getImagepath() %>" width="70" />
                            请上传你的主题头像<br/>
                        ...
                        <div class="form-group">
                            ...
                            <input id="username" type="text" class="form-control" name="subjectDescription" id="name" width="200px" height="80px" value=""
                                   placeholder="请输入名称"> <p class="help-block"><s:fielderror fieldName="subjectDescription"></s:fielderror></p>
                        </div>
